...
viewValidation model =
    if not (String.any isDigit model.password) then
        div [ style "color" "red" ] [ text "Password needs to have at least one number." ]
    else if not (String.any isUpper model.password) then
        div [ style "color" "red" ] [ text "Password needs to have at least one capital letter." ]
    else if not (String.any isLower model.password) then
        div [ style "color" "red" ] [ text "Password needs to have at least one small letter." ]
    else if String.length model.password < 8 then
        div [ style "color" "red" ] [ text "Password needs to be at least 8 characters"]
